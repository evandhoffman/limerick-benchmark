...
class MainCliTests(unittest.TestCase):
    ...
    def test_run_passes_round_controls_to_runner(self) -> None:
        with (
            mock.patch("benchmark.__main__.load_catalog", return_value={}),
            mock.patch("benchmark.__main__.get_pulled_names", return_value=set()),
            mock.patch("benchmark.__main__.preflight_check", return_value=True),
        ...
        self.assertEqual(run_benchmark_mock.call_args.kwargs["rounds"], 5)
        self.assertEqual(run_benchmark_mock.call_args.kwargs["order"], "random")
        self.assertEqual(run_benchmark_mock.call_args.kwargs["seed"], 17)
